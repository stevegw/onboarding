  ...
  "topics": [
    {
      ...
      "content": [
        ...
        },
        {
          ...
          "headers": ["Stratégie", "Description", "Exemple"],
          "rows": [
            ["Assemblage à la commande", "Concevoir des produits avec une liste finie de choix d'options discrets pour les caractéristiques clés. La fabrication s'exécute sans implication du développement produit.", "Véhicules de tourisme, équipements lourds, ordinateurs"],
            ["Assemblage sur stock", "Concevoir un produit général avec plusieurs variations discrètes composées de changements mineurs dans les caractéristiques.", "Produits de consommation en plusieurs couleurs et tailles (vêtements, appareils électroménagers)"],
            ["Configuration à la commande", "Concevoir des produits flexibles qui peuvent être configurés ou personnalisés pour répondre aux besoins uniques des clients à l'aide d'un configurateur avec des règles.", "Équipements industriels, logiciels d'entreprise avec options interdépendantes"],
            ["Ingénierie à la commande", "Comme la configuration à la commande, mais nécessite l'implication de l'équipe d'ingénierie pour la validation et la conception sur mesure par commande.", "Systèmes complexes (turbines, composants aéronautiques) nécessitant une revue d'ingénierie"],
            ["Contrat", "Conception et fabrication entièrement sur mesure selon les spécifications du client. Produit unique par contrat.", "Conceptions uniques -- systèmes de défense, infrastructures personnalisées"]
          ]
        },
        {
          "type": "callout",
        ...
        },
        {
          ...
          "pairs": [
            {"left": "Un constructeur automobile propose des packs avec des options prédéfinies comme Sport, Luxe et Base", "right": "Assemblage à la commande"},
            {"left": "Un fabricant de turbines conçoit chaque produit avec une revue d'ingénierie selon les spécifications du client", "right": "Ingénierie à la commande"},
            {"left": "Une marque de vêtements produit des chemises en 5 couleurs et 4 tailles", "right": "Assemblage sur stock"},
            {"left": "Un sous-traitant de défense construit un système radar unique pour un contrat militaire", "right": "Contrat"}
          ]
        }
      ],
      "keyTakeaways": [
    ...
    },
    {
      ...
      "content": [
        ...
        {
          "type": "comparison-table",
          "headers": ["Pratique", "Description"],
          "rows": [
            ["Structure produit modulaire", "Décomposer le produit en sections modulaires prenant en charge des fonctions spécifiques. Les modules peuvent être partagés entre les produits."],
            ["Structure produit surchargée", "Des sections de la structure contiennent plusieurs conceptions pour satisfaire différents niveaux de capacité pour cette fonction."],
            ["Gestion des options", "Définir des options et des choix pour identifier les caractéristiques variables. Affecter des choix aux conceptions dans les sections surchargées pour contrôler la sélection."],
            ["Structure de commande", "Une structure d'article sans options supplémentaires, reflétant une commande de vente spécifique. Analysée, testée et validée."]
          ]
        },
        {
          "type": "callout",
    ...
    },
    {
      ...
      "content": [
        ...
        {
          "type": "comparison-table",
          "headers": ["Approche métier", "Capacité Windchill", "Fonctionnement"],
          "rows": [
            ["Assemblage à la commande / Assemblage sur stock", "Options et choix pour le filtrage", "Les options et choix filtrent une structure produit surchargée. Les commandes sont généralement créées via un configurateur de vente externe (ATO) ou dans Windchill (ATS)."],
            ["Configuration à la commande / Ingénierie à la commande", "Options basées sur des listes + paramètres", "Les options basées sur des listes filtrent la structure, tandis que les paramètres fournissent une logique de sélection avancée pour une configuration supplémentaire."]
          ]
        },
        {
          "type": "heading",
        ...
        },
        {
          ...
          "pairs": [
            {"left": "Options et choix", "right": "Filtrer les structures surchargées à l'aide de sélections discrètes"},
            {"left": "Paramètres", "right": "Fournir une logique de sélection avancée avec des contraintes"},
            {"left": "Spécification de variante", "right": "Enregistrer les entrées utilisées pour générer une variante spécifique"},
            {"left": "Module configurable", "right": "Désigner les sections produit avec plusieurs variations de conception"}
          ]
        }
      ],
      "keyTakeaways": [
